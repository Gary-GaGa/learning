# 05 - External Task pattern (and workers)
...
Deploy `external-task-demo.bpmn` via Cockpit (same as Chapter 03).
...
Chapter 06 ties this to incidents.
...
Continue to [06 - Variables, errors, and retries](06-variables-errors-retries.md).
