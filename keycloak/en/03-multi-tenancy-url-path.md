# 03 - Multi-tenancy (URL path, single realm)
...
sequenceDiagram
  ...
  U->>API: GET /t/acme/reports (Authorization: Bearer TOKEN)
...
Continue to [04 - Token claims: tenantId & mappers (manual)](04-token-claims-tenant.md).
